...
class LoyaltyPointsExchange extends Equatable {
  ...
  /// Create a [LoyaltyPointsExchange] object
  const LoyaltyPointsExchange({
    this.amount = 0,
  ...
  /// Clone and return a new [LoyaltyPointsExchange] object
  LoyaltyPointsExchange copyWith({
    int? loyaltyId,
