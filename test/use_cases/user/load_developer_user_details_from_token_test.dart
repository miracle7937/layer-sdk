...
void main() {
  ...
  late LoadDeveloperUserDetailsFromTokenUseCase _loadDeveloperUserDetails;

  final _mockedUser = User(id: 'id');

  setUp(() {
    _repository = MockUserRepository();
    _loadDeveloperUserDetails = LoadDeveloperUserDetailsFromTokenUseCase(
      repository: _repository,
    );

    when(
      () => _loadDeveloperUserDetails(
        developerId: any(named: 'developerId'),
  ...
  test('Should return an User', () async {
    final response = await _loadDeveloperUserDetails(
